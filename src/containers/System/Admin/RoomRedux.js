...
class RoomRedux extends Component {
    constructor(props) {
        super(props);
        this.state = {
            genderArr: [],
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        ...
        if (prevProps.listRooms !== this.props.listRooms) {
    ...
    handleSaveRoom = () => {
        ...
        if (action === CRUD_ACTIONS.EDIT) {
            this.props.editARoomRedux({
                id: this.state.roomEditId,
                firstName: this.state.firstName,
                lastName: this.state.lastName,
                address: this.state.address,
                phoneNumber: this.state.phoneNumber,
    ...
    handleEditRoomFromParent = (room) => {
        let imageBase64 = '';
        if (room.image) {
            imageBase64 = new Buffer(room.image, 'base64').toString('binary');
        }
    ...
    render() {
        ...
        return (
            <div className='room-redux-container'>
                <div className='room-redux-title'>
                    Room Redux Apocalypse
                </div>
                <div className="room-redux-body" >
                        ...
                        <form>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select id="manage-room.position"
                                        class="form-control my-3"
                                        value={position}
                            ...
                            <div className='form-row'>
                                ...
                                >{this.state.action === CRUD_ACTIONS.EDIT ? "Save edit" : "Save room"}
                                </button>
                            </div>
                            ...
                            <div className='form-row'>
                                <TableManageRoom
                                    handleEditFromParentKey={this.handleEditRoomFromParent}
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        createNewRoom: (data) => dispatch(actions.createNewRoom(data)),
        // editARoomRedux: (data) => dispatch(actions.editARoom(data))

    };
};

export default connect(mapStateToProps, mapDispatchToProps)(RoomRedux);
