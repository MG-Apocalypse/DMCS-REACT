...
import TableInforuser from './TableInforuser';
            ...
            <div className='user-redux-container'>
                ...
                <div className="user-redux-body" >
                    <div className='container' >
                        <form hidden={this.state.action === CRUD_ACTIONS.EDIT ? false : true}>
                            <div className='row' >
                            ...
                            <div className='form-row'>
                                <button
                                    ...
                                    hidden={this.state.action === CRUD_ACTIONS.EDIT ? false : true}
